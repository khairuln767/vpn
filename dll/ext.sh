...
wget -q -O /usr/bin/add-host "https://raw.githubusercontent.com/KhaiVpn767/vpn/main/ssh/add-host.sh" && chmod +x /usr/bin/add-host
wget -q -O /usr/bin/about "https://raw.githubusercontent.com/KhaiVpn767/vpn/main/ssh/about.sh" && chmod +x /usr/bin/about
