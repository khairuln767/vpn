...
LLatest=`date`
Get_Data () {
git clone https://github.com/KhaiVpn767/user-backup-db.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/KhaiVpn767/user-backup-db
    git push -f https://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@github.com/KhaiVpn767/user-backup-db.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/KhaiVpn767/user-backup-db/main/$NameUser/$NameUser.zip"
sleep 1
