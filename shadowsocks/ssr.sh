...
wget -q --no-check-certificate https://raw.githubusercontent.com/KhaiVpn767/vpn/main/core/ssr-core.sh -O /etc/init.d/ssrmu
...
Start_SSR(){
	check_pid
	wget -q -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/KhaiVpn767/vpn/main/core/ssr-core.sh"
...
Install_SSR
systemctl restart ssrmu > /dev/null 2>&1
#wget -q -O /usr/bin/ssr raw.githubusercontent.com/KhaiVpn767/scriptvps/main/shadowsocks/ssrmu.sh && chmod +x /usr/bin/ssr
